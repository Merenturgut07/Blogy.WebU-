...
namespace Blogy.DataAccesLayer.Migrations
{
    ...
    [Migration("20250331103510_mig_comment_imageurl")]
    partial class mig_comment_imageurl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blogy.EntityLayer.Concrete.AdminMessage", b =>
                {
            ...
            modelBuilder.Entity("Blogy.EntityLayer.Concrete.BlogAboutBloggerPublishing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("blogAboutBloggerPublishings");
                });

            modelBuilder.Entity("Blogy.EntityLayer.Concrete.BlogAboutPictureOrDescription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("blogAboutPictureOrDescriptions");
                });

            modelBuilder.Entity("Blogy.EntityLayer.Concrete.BlogAboutService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("blogAboutServices");
                });

            modelBuilder.Entity("Blogy.EntityLayer.Concrete.BlogSendContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("blogSendContacts");
                });

            modelBuilder.Entity("Blogy.EntityLayer.Concrete.Browser", b =>
                {
                    ...
                    b.Property<string>("BrowserImage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("BrowserValue")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Blogy.EntityLayer.Concrete.LayoutAbout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Blogy.EntityLayer.Concrete.ToDoList", b =>
                {
            ...
            modelBuilder.Entity("Blogy.EntityLayer.Concrete.WriterTable", b =>
                {
                    b.Property<int>("WriterTableId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("WriterTableId"), 1L, 1);
            ...
            modelBuilder.Entity("Blogy.EntityLayer.Concrete.Article", b =>
                {
                    ...
                    b.HasOne("Blogy.EntityLayer.Concrete.WriterTable", "Writer")
                        .WithMany("Articles")
